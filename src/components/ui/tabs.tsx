...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center bg-muted p-0.5 text-muted-foreground/70",
      className,
    )}
    {...props}
  />
