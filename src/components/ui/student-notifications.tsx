...
import { Bell, Check, User, BookOpen, ChevronRight, X } from 'lucide-react';
...
export default function StudentNotifications({}: StudentNotificationsProps) {
              ...
              {notifications.map((notification) => (
                <div
                  ...
                  className={cn(
                    ...
                    !notification.read && "bg-gray-900/30 border-l-2 border-l-blue-500"
                  )}
                >
