...
window.location.href = '/faculty/coursesavailable';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Check if email has gmail.com domain (not allowed for faculty)
      ...
      <div className="flex items-center justify-center p-8 bg-black">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2">Faculty Login</h1>
            <p className="text-muted-foreground text-sm">Access your faculty portal</p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-sm font-medium">Faculty Email</Label>
              <Input
                id="email"
                type="email"
...
export const Component = FacultyLoginPage;