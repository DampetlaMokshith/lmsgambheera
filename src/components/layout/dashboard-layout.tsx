...
import { LayoutDashboard, BookOpen, Code, Award, Menu, X, User, ChevronDown, LogOut, Bell } from 'lucide-react';
import Image from 'next/image';
import SuggestiveSearch from '@/components/ui/suggestive-search';
import WelcomeNotification from '@/components/ui/welcome-notification';
      ...
      <div className="flex w-full h-screen">
            ...
            <div className="absolute left-0 top-0 h-full w-64 bg-black border-r border-white/10">
              ...
              <div className="flex items-center justify-between p-4 border-b border-white/10">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-bold text-lg">MBU LMS</span>
                </div>
                <button 
                  onClick={() => setIsMobileSidebarOpen(false)}
        ...
        <div className="md:ml-16 flex-1 flex flex-col">
          ...
          <main className="pt-16 flex-1 overflow-auto bg-black">
            <div className={fullscreen ? "h-full" : "p-4 md:p-6 h-full"}>
